    ...
    <PageWrapper>
      ...
      {submitted ? (
        <section className="mt-6 grid gap-4">
          ...
          {teachers.map((teacher, index) => <AIMatchCard key={teacher.id} teacher={teacher} top={index === 0} reason="Subject, timing, rating aur location ke basis par yeh aapke liye strong fit hain." />)}
        </section>
      ) : null}
    </PageWrapper>
  );
