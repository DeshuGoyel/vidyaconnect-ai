...
export default function ProfilePage() {
  ...
  return (
    <PageWrapper className="pt-6 space-y-6">
      {/* Role Switcher Tabs */}
      <div className="bg-white rounded-2xl border border-slate-200 p-2 shadow-soft">
      ...
      <AnimatePresence mode="wait">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-card">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-500 mt-0.5">aryan.k@gmail.com • Lajpat Nagar, Delhi</p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white rounded-2xl p-5 border border-slate-800 shadow-elevated">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-semibold text-indigo-300 uppercase tracking-wider">Parent Monitoring Active</span>
              </div>
              <h2 className="font-display font-bold text-lg text-white">Ramesh Kumar (Parent)</h2>
              <p className="text-xs text-slate-300 mt-1">Connected to Aryan's VidyaConnect Account • WhatsApp updates enabled</p>
            </div>
        ...
        {/* ── 3. TEACHER ROLE VIEW (Priya Sharma Profile) ── */}
        {roleMode === "teacher" && (
          <motion.div
            key="teacher"
            initial={{ opacity: 0, y: 8 }}
